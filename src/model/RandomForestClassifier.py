...
def main():
    # Load config
    with open(r"yaml\RandomForestClassifier.yaml", "r") as f:
    ...
    # Save metrics
    with open(os.path.join(metrics_dir, "RandomForestClassifier_metrics.json"), "w") as f:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(plots_dir, "RandomForestClassifier_cm.png"))
    plt.close()
