...
def main():
    ...
    with mlflow.start_run(run_name="RandomForestClassifier"):
        ...
        # Log params (flattened so they render nicely in MLflow)
        ...
        # --- Persist locally (kept from your pipeline) ---
        model_path = os.path.join(model_dir, "RandomForestClassifier_model.pkl")
        with open(model_path, "wb") as f:
            pickle.dump(model, f)

        # --- Log model to MLflow/DagsHub for comparison ---
        ...
        # robust per-class recall logging (handles labels not being '0'/'1')
        ...
        # Save full report for your pipeline + log as artifact
        ...
        # Also log raw CM as CSV (handy when comparing)
