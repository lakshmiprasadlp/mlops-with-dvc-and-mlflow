...
import dagshub
from logger import get_logger  # ✅ logger from your package

from sklearn.ensemble import RandomForestClassifier, StackingClassifier
from sklearn.linear_model import LogisticRegression
from sklearn.metrics import classification_report, confusion_matrix, recall_score

logger = get_logger("StackingClassifier")
...
def main():
    ...
    with mlflow.start_run(run_name="StackingClassifier"):
        ...
        logger.info("Initializing base RandomForestClassifier estimators...")
        ...
        logger.info("Creating StackingClassifier with LogisticRegression final estimator...")
        model = StackingClassifier(
            estimators=[("rf1", rf1), ("rf2", rf2), ("rf3", rf3)],
            final_estimator=LogisticRegression(**config["final_estimator"])
        )

        logger.info("Training StackingClassifier model...")
        ...
        logger.info(f"Classification report saved and logged: {metrics_json_path}")
    ...
    logger.info("StackingClassifier run completed successfully.")
