...
def main():
    # Load config
    with open("StackingClassifier.yaml", "r") as f:
    ...
    # Save metrics
    with open(os.path.join(metrics_dir, "StackingClassifier_metrics.json"), "w") as f:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(plots_dir, "StackingClassifier_cm.png"))
    plt.close()
